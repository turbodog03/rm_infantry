...
//UART 设备端口定义
#define DBUS_UART         1 //遥控器接收机串口 USART1
#define NUC_UART					4	//视觉上位机串口
#define BLUETOOTH_UART		5	//蓝牙调试串口
#define REFEREE_UART			3 //裁判系统串口

#define USER_UART1        1 //用户串口1，遥控器接收机使用
#define USER_UART2        2 //用户串口2 USART3
#define USER_UART3        3 //用户串口3 USART6
#define USER_UART4        4 //用户串口4 UART8
#define USER_UART5        5 //用户串口5 UART7
